        ...
        <section className="container marketing">
            ...
            <article className="row featurette middle">
                ...
                <div className="col-md-5">
                    <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" src={working} alt="" width="500" height="500" />
                </div>
            </article>
            ...
            <article className="row featurette middle">
                ...
                <div className="col-md-5 order-md-1">
                    <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" src={safety} alt="" width="500" height="500" />
                </div>
            </article>
            ...
            <article className="row featurette middle">
                ...
                <div className="col-md-5">
                    <img className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" src={cheaper} alt="" width="500" height="500" />
                </div>
            </article>
        </section>
    )
